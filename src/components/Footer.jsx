    ...
    return (
        <section className='footer bg-customBeigeMuda'>
            <footer className="flex flex-col md:flex-row justify-between p-10">
                <div className="flex flex-col md:flex-row items-center mb-10 md:mb-0">
                ...
                <div className="flex flex-col items-start md:mt-0 md:mr-20"> 
                ...
                <div className="flex flex-col items-start mt-10 md:mt-0"> 
                    ...
                    <div className="flex space-x-4">
                        <a 
                         ...
                         className="text-regular text-color_neutral_600_light hover:underline">
                        ...
                        <a href="https://www.instagram.com/identitas_souvenir" className="flex items-center space-x-2"> 
                            <div className="w-12 h-12 bg-customMaroon hover:bg-customTaupe rounded-full flex items-center justify-center">
